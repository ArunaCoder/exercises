...
fn main() {
    ...
    println!("Original: '{}' → Reversed: '{}'", text1, reverse_string(text1));
    println!("Original: '{}' → Reversed: '{}'", text2, reverse_string(text2));
    println!("Original: '{}' → Reversed: '{}'", text3, reverse_string(text3));
}
