// EXIT LOOP
// Crie uma opção que permita ao usuário digitar 0 para sair do programa
// Permita que o usuário faça diversas conversões e saia apenas quando quiser
...
fn main() {
    loop {
        ...
        //TODO: Inclua um ramo de execução (if) para a entrada 0. Este braço terá um break.
